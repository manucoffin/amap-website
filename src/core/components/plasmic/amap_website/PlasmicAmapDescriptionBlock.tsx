...
export const PlasmicAmapDescriptionBlock__VariantProps = new Array<VariantPropType>();
...
export const PlasmicAmapDescriptionBlock__ArgProps = new Array<ArgPropType>('children', 'title');
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <BrushIcon className={classNames(projectcss.all, sty.svg__fpYPs)} role={'img'} />

              <div className={classNames(projectcss.all, projectcss.__wab_text, sty.text__sS8E)}>
                {'Solidaire'}
              </div>
            </React.Fragment>
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <li className={classNames(projectcss.all, projectcss.li, sty.li__msfYk)}>
                <ListItem className={classNames('__wab_instance', sty.listItem__mGkDp)}>
                  <div
                    className={classNames(projectcss.all, projectcss.__wab_text, sty.text___7Wr43)}
                  >
              ...
              <li className={classNames(projectcss.all, projectcss.li, sty.li__qbcx9)}>
                <ListItem className={classNames('__wab_instance', sty.listItem__lti77)}>
                  <div
                    className={classNames(projectcss.all, projectcss.__wab_text, sty.text__qrGv9)}
                  >
                    {
              ...
              <li className={classNames(projectcss.all, projectcss.li, sty.li__jKDeD)}>
                <ListItem className={classNames('__wab_instance', sty.listItem___6SxMq)}>
                  <div
                    className={classNames(projectcss.all, projectcss.__wab_text, sty.text__cdBiA)}
                  >
              ...
              <li className={classNames(projectcss.all, projectcss.li, sty.li___2ID)}>
                <ListItem className={classNames('__wab_instance', sty.listItem__wxcOr)}>
                  <div
                    className={classNames(projectcss.all, projectcss.__wab_text, sty.text__px9Wx)}
                  >
                    {
