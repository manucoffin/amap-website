...
import sty from './PlasmicTextInput.module.css'; // plasmic-import: 4PfogoODGJ2/css
    ...
    >
      {(hasVariant(variants, 'showStartIcon', 'showStartIcon') ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon className={classNames(projectcss.all, sty.svg__rbOhc)} role={'img'} />
            ),
      ...
      <input
        ...
        name={args.name}
        placeholder={
          args.placeholder !== undefined ? args.placeholder : ('Enter something…' as const)
        }
        type={'text' as const}
        value={args.value}
      />
      ...
      {(hasVariant(variants, 'showEndIcon', 'showEndIcon') ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon className={classNames(projectcss.all, sty.svg__oGe0)} role={'img'} />
            ),
