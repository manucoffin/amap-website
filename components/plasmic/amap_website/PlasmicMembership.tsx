...
export const PlasmicMembership__ArgProps = new Array<ArgPropType>('description');
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta key="og:title" property="og:title" content={"AMAP de la Goutte d'Eau - Adhérer"} />
      </Head>
...
const PlasmicDescendants = {
  root: ['root', 'header', 'h1', 'img', 'downloadButton', 'text', 'description'],
  header: ['header'],
  h1: ['h1'],
  img: ['img'],
