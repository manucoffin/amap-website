...
export const PlasmicArticleCard__VariantProps = new Array<VariantPropType>('horizontal');
...
export const PlasmicArticleCard__ArgProps = new Array<ArgPropType>('title', 'date', 'abstract');
    ...
    >
      <div
        ...
        className={classNames(projectcss.all, sty.thumbnail, {
          [sty.thumbnailhorizontal]: hasVariant(variants, 'horizontal', 'horizontal'),
        })}
      ...
      {true ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__qW8Fy, {
            [sty.freeBoxhorizontal__qW8Fyzc7Xk]: hasVariant(variants, 'horizontal', 'horizontal'),
          })}
        >
          <div
          ...
          >
            {p.renderPlasmicSlot({
              ...
              className: classNames(sty.slotTargetTitle, {
                [sty.slotTargetTitlehorizontal]: hasVariant(variants, 'horizontal', 'horizontal'),
              }),
            })}
          </div>
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__ubBr, {
              [sty.freeBoxhorizontal__ubBrzc7Xk]: hasVariant(variants, 'horizontal', 'horizontal'),
            })}
          >
            {p.renderPlasmicSlot({
              ...
              className: classNames(sty.slotTargetDate, {
                [sty.slotTargetDatehorizontal]: hasVariant(variants, 'horizontal', 'horizontal'),
              }),
            })}
          </div>
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__evEzu, {
              [sty.freeBoxhorizontal__evEzuzc7Xk]: hasVariant(variants, 'horizontal', 'horizontal'),
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents:
