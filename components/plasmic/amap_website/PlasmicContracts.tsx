  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta key="og:title" property="og:title" content={"AMAP de la Goutte d'Eau - Contrats"} />
      </Head>
            ...
            <div className={classNames(projectcss.all, sty.freeBox__frs9T)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    <ContractCard
                      className={classNames('__wab_instance', sty.contractCard__yu3Xr)}
                    ...
                    <ContractCard
                      className={classNames('__wab_instance', sty.contractCard__iXzZx)}
                    />

                    <ContractCard
                      className={classNames('__wab_instance', sty.contractCard__rNzW)}
                    />

                    <ContractCard className={classNames('__wab_instance', sty.contractCard__u7F)} />

                    <ContractCard
                      className={classNames('__wab_instance', sty.contractCard__n8ZdE)}
                    />

                    <ContractCard className={classNames('__wab_instance', sty.contractCard__yAk)} />

                    <ContractCard
                      className={classNames('__wab_instance', sty.contractCard__bjowd)}
                    />
                  </React.Fragment>
                ),
