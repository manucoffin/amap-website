...
export const PlasmicContract__ArgProps = new Array<ArgPropType>('description', 'title');
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta key="og:title" property="og:title" content={"AMAP de la Goutte d'Eau - Contrat"} />
      </Head>
...
const PlasmicDescendants = {
  root: ['root', 'header', 'freeBox', 'h1', 'image', 'downloadButton', 'text', 'description'],
  header: ['header'],
