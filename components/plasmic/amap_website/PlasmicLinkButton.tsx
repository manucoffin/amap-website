...
export type PlasmicLinkButton__VariantMembers = {
  ...
  size: 'xs' | 'sm' | 'md' | 'lg' | 'xl';
  radius: 'none' | 'sm' | 'md' | 'lg' | 'xl' | '_2Xl' | '_3Xl' | 'full' | 'normal';
};
...
export const PlasmicLinkButton__VariantProps = new Array<VariantPropType>('type', 'size', 'radius');
...
export const PlasmicLinkButton__ArgProps = new Array<ArgPropType>('href', 'children');
